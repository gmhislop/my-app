        ...
        <nav className='nav'>
            <div>
                ...
                <svg style={{height: '20px', width: '20px', backgroundColor: 'white'}} enable-background="new 0 0 2088.1 730.2" viewBox="0 0 2088.1 730.2" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="m1858.6 386.7h56.7c1.3-7 1.9-14.3 1.9-21.7 0-67.2-54.5-121.7-121.7-121.7s-121.7 54.5-121.7 121.7 54.5 121.7 121.7 121.7c46.7 0 72.7-11 72.7-11l-10.8-54.7s-24.9 10.8-58.4 10.8c-52.5 0-66.6-45-66.6-45h125.5zm-125.7-44.4c9.3-25.6 33.9-43.9 62.7-43.9 28.7 0 53.3 18.3 62.6 43.8v.2h-125.5z"/></g>
                </svg>
                ...
                <a href="/pages/match" className={location.pathname === '/pages/match' ? 'nav__link active': 'nav__link'}>
