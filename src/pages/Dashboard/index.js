				...
				<section className="home-section">
						...
						<div className="overview-boxes">
							<div className="box">
								<div className="right-side">
									<div className="box-topic">Total Caregivers</div>
							...
							<div className="box">
								<div className="right-side">
									<div className="box-topic">Open Bookings</div>
                    ...
                    <li>
								...
								<div className="button">
									<a href="/pages/bookings">See All</a>
								</div>
							</div>
							<div className="top-sales box">
								<div className="title">Top Caregivers</div>
